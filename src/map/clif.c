...
{
	const struct packet_bgqueue_register *p = P2PTR(fd);
...
{
	const struct packet_bgqueue_revoke_req *p = P2PTR(fd);
...
{
	const struct packet_bgqueue_battlebegin_ack *p = P2PTR(fd);
